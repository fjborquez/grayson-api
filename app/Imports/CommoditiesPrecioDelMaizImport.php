...
class CommoditiesPrecioDelMaizImport implements ToModel, WithHeadingRow, WithGroupedHeadingRow
{
    ...
    */
    public function model(array $row)
    {
        ...
        $datoExistente = Dato::where('clave', $row['frequency'])->where('valor', $row['monthly'][38])
